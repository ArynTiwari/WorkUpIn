      ...
      <section className="big-feature-section ">
        <div className="container flex items-center big-feature-container">
          ...
          <div className="feature-desc flex items-center">
            ...
            <p className="text-lg text-justify">Are you a talented design professional looking for new opportunities to showcase your skills and connect with clients from around the world? WorkUp offers effortless validation and empowers you to reach new heights in your career.</p>
          </div>
        </div>
      </section>
    </>
