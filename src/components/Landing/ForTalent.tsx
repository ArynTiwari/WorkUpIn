      ...
      <section className="big-feature-section ">
        <div className="container flex items-center big-feature-container">
          <div className="feature-desc flex items-center">
            ...
            <p className="text-lg text-justify">Are you a skilled content writer seeking exciting opportunities to showcase your creativity and collaborate with clients from all corners of the globe? WorkUp provides a seamless validation process and empowers you to excel in your writing career.</p>
          </div>
