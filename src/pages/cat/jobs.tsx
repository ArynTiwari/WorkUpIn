...
const dev_sam = () => {
  return (
    <div className=''>
      ...
      <div className='text-black-600 font-momo font-bold mt-8 text-4xl lg:ml-24 pl-7 sm:pl-7 md:pl:7 pt-24'>Job Details</div>
      <div className="flex-row bg-white-500 border-1  gap-3 rounded-2xl grid grid-cols-1 divide-x-0 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-6 border-transparent lg:mr-24 lg:ml-24 mt-3" >
        <div className="grid-1 item border-none rounded overflow-hidden shadow-lg col-span-4">
          <div className="px-6 py-4 mt-4 text-black ">
            <div className="mb-2 text-2xl font-momo ">
              Need To hire android apps uploader
            </div>

            <p className=" text-base text-blue-500 text-1xl pt-11">
            ...
            <p className=" text-base text-slate-800 text-0.5xl pt-3">
              ...
              Need To hire android apps uploader
              <br></br><br></br>
              If You Have A Play Console Account And You Have Ready To Upload My Android Apps in your Play console Than Connect with me.
              <br></br><br></br>
              My budget is 25$ for 13 apps live on play console
              <br></br><br></br>

              Hiring Of 25 freelancers in his job.
              <br></br><br></br>
              connect faster
              <br></br><br></br>
              thank you
        ...
        <div className="grid-1 item border-none rounded overflow-hidden shadow-lg col-span-2">
          <div className="px-6 py-4 mt-4 text-black">
            <button className="bg-green-500 rounded-full px-14 py-1 pb-2 mx-3 hover:bg-sky-700">
              Submit a Proposal
            </button>

            <button className="bg-green-300 rounded-full px-24 py-1 pb-2 mx-3 hover:bg-sky-700 mt-5">
              Save Job
            </button>
